'use client';
// app/admin/activities/own/page.tsx
// Reseller's own activities page
...
export default function OwnActivitiesPage() {
  ...
  const fetchActivities = async () => {
    try {
      ...
      const res = await fetch(`/api/admin/activities/own?${params}`, {
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          >
            ...
            <option value="SELLER_ADD">Create License</option>
